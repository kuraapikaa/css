...
```
https://cdn.jsdelivr.net/gh/kuraapikaa/css@126dfea/NarcosBahis/narcos-tema-birlesik.css
```
...
`@126dfea` sabit commit hash'i. Tema güncellendiğinde bu satırdaki hash'i
