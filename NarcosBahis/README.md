...
```
https://cdn.jsdelivr.net/gh/kuraapikaa/css@08d2012/NarcosBahis/narcos-tema-birlesik.css
```
...
(function () {
  ...
  s.src = "https://cdn.jsdelivr.net/gh/kuraapikaa/css@08d2012/NarcosBahis/narcos-hepsi-birlesik.js";
  s.async = false;          // defer DEĞİL — aşağıdaki nota bak
  document.head.appendChild(s);
})();
```

`@08d2012` sabit commit hash'i. Tema güncellendiğinde bu satırdaki hash'i
